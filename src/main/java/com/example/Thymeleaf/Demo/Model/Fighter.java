...
public class Fighter {
    ...
    @DecimalMin(value = "0.0", inclusive = true, message = "Resistance must be between 0 and 10")
    @DecimalMax(value = "10.0", inclusive = true, message = "Resistance must be between 0 and 10")
